...
const Home = () => {
  ...
  return (
    <div className="min-h-screen w-full">
      ...
      <section className="max-w-4xl mx-auto px-4 md:px-8 pt-16 md:pt-28 pb-12 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-blue-600/10 border border-blue-500/20 text-blue-400 text-xs font-medium px-4 py-1.5 rounded-full mb-4">
          <span className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-fade"></span>
